...
import com.iqianbang.fanpai.adapter.InvestJiLuAdapter;
...
public class JiLuActivity extends Activity {
    ...
    private ArrayList<InvestJiLuBean> list = new ArrayList<InvestJiLuBean>();
    private InvestJiLuAdapter adapter;
    ...
    private void initData() {
        ...
        // 5.设置adapter
        adapter = new InvestJiLuAdapter(this, list);
    ...
    private void getDataFromServer() {
        ...
        VolleyUtil.sendJsonRequestByPost(ConstantUtils.INVESTRECORD_URL,
                        ...
                        if ("0".equals(code)) {
                            ...
                            if (StringUtils.isBlank(datastr)) {
                                ...
                                if (isSuccess) {// 验签成功
                                    ...
                                    ArrayList<InvestJiLuBean> listadd = (ArrayList<InvestJiLuBean>) JSONArray.parseArray(getList.toJSONString(), InvestJiLuBean.class);
                                    list.addAll(listadd);
