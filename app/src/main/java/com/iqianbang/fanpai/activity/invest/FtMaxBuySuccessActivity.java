...
public class FtMaxBuySuccessActivity extends BaseActivity {
    ...
    public static String FLAG_MAXBUYSUCCESS = "flag_maxbuysuccess";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_btn_invest:
                ...
                intent.putExtra("from", FLAG_MAXBUYSUCCESS);
