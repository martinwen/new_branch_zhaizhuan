...
import static com.iqianbang.fanpai.R.id.tv_day;
...
public class FtMaxBuyConfirmActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ft_max_buy_confirm);
    ...
    private void initData() {
        ...
        tvYue.setText(MathUtil.subString(buy_money, 2) + "元");

        //出借总计
        zong_money = intent.getStringExtra("zong_money");
        tvMoney.setText(MathUtil.subString(zong_money, 2) + "元");

        //使用奖金
        jiangjin_money = intent.getStringExtra("et_jiangjin_money");
        tvJiang.setText(MathUtil.subString(jiangjin_money, 2) + "元");

        //使用小饭团
        fhAmount = intent.getStringExtra("fhAmount");
        tvXiaofantuan.setText(MathUtil.subString(fhAmount, 2) + "元");

        // 加息
        String jiaxi = intent.getStringExtra("jiaxi");
        tvRate.setText(jiaxi + "%");

        //出借期限
        String investDays = intent.getStringExtra("investDays");
        tvDay.setText(investDays + "天");
                ...
                new HttpBackBaseListener() {
                    ...
                    public void onSuccess(String string) {
                        ...
                        if (endTime - startTime > 12000) {
                            progressdialog.dismiss();
                            Intent intent = new Intent(FtMaxBuyConfirmActivity.this, BuyShenQingActivity.class);
                            ...
                            if ("0".equals(code)) {
                                ...
                                Intent intent = new Intent(FtMaxBuyConfirmActivity.this, FtMaxBuySuccessActivity.class);
