...
public class ZhuanRangProjectActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhitou_project);
    ...
    @OnClick({R.id.iv_back, R.id.ll_zhaiquan, R.id.ll_zhuanrang, R.id.ll_zijin, R.id.tv_btn_finish})
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_zhaiquan:
                ...
                break;
            case R.id.ll_zijin:
                intent = new Intent(this, ZhuanRangLiuShuiActivity.class);
            ...
            case R.id.tv_btn_finish:
                ...
                if ("20".equals(status)) {//20 转让中   撤回
                    ZhuanRangCheXiaoDialog zhuanRangCheXiaoDialog = new ZhuanRangCheXiaoDialog(this, R.style.YzmDialog, id, transSeq, holdMoney, "transfer");
    ...
    private void getDataFromServer() {
        ...
        VolleyUtil.sendJsonRequestByPost(ConstantUtils.SHOWTRANSFERINVESTRECORDINFODETAIL_URL,
                        ...
                        if ("0".equals(code)) {
                            ...
                            if (StringUtils.isBlank(datastr)) {
                                ...
                                if (isSuccess) {// 验签成功
                                    ...
                                    //投资记录名称
                                    String transferName = data.getString("transferName");
                                    ...
                                    tvChengjie.setText(payAmount + "元");
