...
import com.iqianbang.fanpai.adapter.hongbao.HongBaoUseableAdapter;
...
public class HongBaoActivity extends BaseActivity {
    ...
    private void initView(){
        ...
        // 5.设置adapter
        adapter=new HongBaoUseableAdapter(this, list);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_shixiao:
                startActivity(new Intent(this, HongBaoShiXiaoActivity.class));
                break;
            case R.id.tv_title:
                ...
                tv_up.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(HongBaoActivity.this, JiaXiPiaoActivity.class));
                        finish();
                    }
                });
                ...
                tv_middle.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(HongBaoActivity.this, YouXianGouActivity.class));
                        finish();
                    }
                });
                ...
                tv_down.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(HongBaoActivity.this, TiXianPiaoActivity.class));
                        finish();
                    }
                });
