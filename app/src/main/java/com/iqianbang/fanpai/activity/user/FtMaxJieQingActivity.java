...
public class FtMaxJieQingActivity extends BaseActivity {
    ...
    private FanWanJieQingAdapter adapter;
    ...
    private void initData() {
        ...
        adapter = new FanWanJieQingAdapter(this, list);
    ...
    class FanWanListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Intent intent = new Intent(FtMaxJieQingActivity.this, FtMaxProjectActivity.class);
