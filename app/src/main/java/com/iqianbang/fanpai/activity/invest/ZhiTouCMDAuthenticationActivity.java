 ...
 * @author lxn
 */
public class ZhiTouCMDAuthenticationActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		private void initData() {
			...
			rewardAcctBal = getIntent().getStringExtra("rewardAcctBal");
	...
	class JavaScriptInterface {
		...
		public void handleBindCardResult(String reutlt) {
			...
			if ("true".equals(reutlt)) {
				Intent intent = new Intent(ZhiTouCMDAuthenticationActivity.this,ZhiTouBuyConfirmActivity.class);
