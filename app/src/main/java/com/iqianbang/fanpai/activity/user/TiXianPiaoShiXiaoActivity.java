...
public class TiXianPiaoShiXiaoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ti_xian_piao_shixiao);
    ...
    private void initView(){
        ...
        // 5.设置adapter
        adapter=new TiXianPiaoUnuseableAdapter(this, list);
