 ...
 * @author lxn
 */
public class FtMinCMDAuthenticationActivity extends BaseActivity {
	...
	class JavaScriptInterface {
		...
		public void handleBindCardResult(String reutlt) {
			...
			if ("true".equals(reutlt)) {
				Intent intent = new Intent(FtMinCMDAuthenticationActivity.this,FtMinBuyConfirmActivity.class);
