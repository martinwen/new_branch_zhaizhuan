...
import com.iqianbang.fanpai.adapter.tixianpiao.TiXianPiaoUseableAdapter;
...
public class TiXianPiaoActivity extends BaseActivity {
    ...
    private ArrayList<TiXianBean> list = new ArrayList<TiXianBean>();
    private TiXianPiaoUseableAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ti_xian_piao);
    ...
    private void initView(){
        ...
        // 5.设置adapter
        adapter=new TiXianPiaoUseableAdapter(this, list);
    ...
    private void getDataFromServer() {
        ...
        VolleyUtil.sendJsonRequestByPost(ConstantUtils.TICKET_URL,
                null, map, new HttpBackBaseListener() {

                    @Override
                    public void onSuccess(String string) {
                        LogUtils.i("提现票可使用==="+string);
                        ...
                        if ("0".equals(code)) {
                            ...
                            if (StringUtils.isBlank(datastr)) {
                                ...
                                if (isSuccess) {// 验签成功
                                    ...
                                    ArrayList<TiXianBean> listadd = (ArrayList<TiXianBean>) JSONArray.parseArray(getList.toJSONString(), TiXianBean.class);
                                    list.addAll(listadd);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_shixiao:
                startActivity(new Intent(this, TiXianPiaoShiXiaoActivity.class));
                break;
            case R.id.tv_title:
                ...
                tv_up.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(TiXianPiaoActivity.this,JiaXiPiaoActivity.class));
                        finish();
                    }
                });
                ...
                tv_middle.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(TiXianPiaoActivity.this,YouXianGouActivity.class));
                        finish();
                    }
                });
                ...
                tv_down.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        pop.dismiss();
                        startActivity(new Intent(TiXianPiaoActivity.this,HongBaoActivity.class));
                        finish();
                    }
                });
