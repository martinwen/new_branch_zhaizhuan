 ...
 * @author lxn
 */
public class FtMaxCMDAuthenticationActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		private void initData() {
			baseBal = getIntent().getStringExtra("et_buy_money");
			rechargeAmount = getIntent().getStringExtra("rechargeAmount");
			jiangjin = getIntent().getStringExtra("et_jiangjin_money");
			fhAmount = getIntent().getStringExtra("fhAmount");
			investTotalAmount = getIntent().getStringExtra("zong_money");
			seqNo=getIntent().getStringExtra("seqNo");
			bindId=getIntent().getStringExtra("bindId");
			jiaxi=getIntent().getStringExtra("jiaxi");
			investDays=getIntent().getStringExtra("investDays");
	...
	class JavaScriptInterface {
		...
		public void handleBindCardResult(String reutlt) {
			...
			if ("true".equals(reutlt)) {
				Intent intent = new Intent(FtMaxCMDAuthenticationActivity.this,FtMaxBuyConfirmActivity.class);
