...
import com.iqianbang.fanpai.adapter.ZhuanRangJieQingAdapter;
...
public class ZhuanRangJieQingActivity extends BaseActivity {
    ...
    private ZhuanRangJieQingAdapter adapter;
    ...
    private void initData() {
        ...
        adapter = new ZhuanRangJieQingAdapter(this, list);
    ...
    class FanWanListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Intent intent = new Intent(ZhuanRangJieQingActivity.this, ZhuanRangProjectActivity.class);
