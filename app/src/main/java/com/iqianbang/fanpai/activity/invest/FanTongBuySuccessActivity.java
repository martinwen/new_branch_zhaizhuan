...
import com.iqianbang.fanpai.activity.user.FtJingYingZaiTouJiLuActivity;
...
public class FanTongBuySuccessActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_btn_invest:
                ...
                intent.putExtra("from", FLAG_JINGYINGBUYSUCCESS);
