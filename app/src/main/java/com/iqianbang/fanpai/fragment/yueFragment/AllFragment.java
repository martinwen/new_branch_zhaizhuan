...
import com.iqianbang.fanpai.adapter.yue.AllAdapter;
...
public class AllFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new AllAdapter(mActivity, list);
