...
public class FtMaxUseablefragment extends BaseFragment {
    ...
    private JiaXiPiaoFwUseableAdapter adapter;
    ...
    protected View initView() {
        ...
        // 5.设置adapter
        adapter=new JiaXiPiaoFwUseableAdapter(mActivity, list);
        ...
        VolleyUtil.sendJsonRequestByPost(ConstantUtils.RATECOUPON_URL,
                null, map, new HttpBackBaseListener() {
                    ...
                    public void onSuccess(String string) {
                        ...
                        LogUtils.i("大饭团可使用的string=="+string);
