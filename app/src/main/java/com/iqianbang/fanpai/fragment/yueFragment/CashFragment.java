...
import com.iqianbang.fanpai.adapter.yue.CashAdapter;
...
public class CashFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new CashAdapter(mActivity, list);
