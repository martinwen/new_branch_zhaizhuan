...
import com.iqianbang.fanpai.adapter.yue.TouZiAdapter;
...
public class TouZiFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new TouZiAdapter(mActivity, list);
