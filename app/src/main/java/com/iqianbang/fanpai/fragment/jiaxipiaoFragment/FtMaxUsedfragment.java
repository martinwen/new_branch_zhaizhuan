...
import com.iqianbang.fanpai.adapter.jiaxipiao.JiaXiPiaoFwUnusedAdapter;
...
public class FtMaxUsedfragment extends BaseFragment {
    ...
    private JiaXiPiaoFwUnusedAdapter adapter;
    ...
    protected View initView() {
        ...
        // 5.设置adapter
        adapter=new JiaXiPiaoFwUnusedAdapter(mActivity, list);
