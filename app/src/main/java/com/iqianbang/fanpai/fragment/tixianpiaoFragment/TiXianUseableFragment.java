package com.iqianbang.fanpai.fragment.tixianpiaoFragment;
...
public class TiXianUseableFragment extends BaseFragment {
	...
	protected View initView() {
		...
		View view = View.inflate(mActivity, R.layout.fragment_jiaxipiao_useable, null);
		...
		// 5.设置adapter
		adapter=new TiXianPiaoUseableAdapter(mActivity, list);
