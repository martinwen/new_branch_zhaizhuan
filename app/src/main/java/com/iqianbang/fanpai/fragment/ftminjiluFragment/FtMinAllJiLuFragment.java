...
import com.iqianbang.fanpai.adapter.fhinvest.FhAllAdapter;
...
public class FtMinAllJiLuFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new FhAllAdapter(mActivity, list);
