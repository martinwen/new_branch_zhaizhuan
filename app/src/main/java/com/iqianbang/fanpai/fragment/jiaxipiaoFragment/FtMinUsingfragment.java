...
import com.iqianbang.fanpai.adapter.jiaxipiao.JiaXiPiaoFhUsingAdapter;
...
public class FtMinUsingfragment extends BaseFragment {
    ...
    private JiaXiPiaoFhUsingAdapter adapter;
    ...
    protected View initView() {
        ...
        View view = View.inflate(mActivity, R.layout.fragment_jiaxipiao_using, null);
        ...
        // 5.设置adapter
        adapter=new JiaXiPiaoFhUsingAdapter(mActivity, list);
