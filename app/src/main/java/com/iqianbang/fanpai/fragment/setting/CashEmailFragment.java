...
public class CashEmailFragment extends BaseFragment {
    ...
    protected View initView() {
        ...
        View view = View.inflate(mActivity, R.layout.fragment_tixian_email, null);
    ...
    public void initData() {
        ...
        //获取保存在本地的账号
        email = CacheUtils.getString(CacheUtils.EMAIL, "");
        //初始化密码显示状态
        etPassword.setTransformationMethod(PasswordTransformationMethod.getInstance());
        etNewPassword.setTransformationMethod(PasswordTransformationMethod.getInstance());
    }

    @OnClick({R.id.iv_yanzheng, R.id.iv_yuyin, R.id.iv_btn, R.id.iv_eye, R.id.iv_eye1})
    ...
    private void check(String idNo) {
        ...
        VolleyUtil.sendJsonRequestByPost(ConstantUtils.VERIFYUSERIDNO_URL, null, map,
                new HttpBackBaseListener() {
                    ...
                    public void onSuccess(String string) {
                        ...
                        String code = json.getString("code");
                        if("0".equals(code)){
                            YzmDialog yzmDialog_yuyin = new YzmDialog(getContext(), R.style.YzmDialog, email);
                            yzmDialog_yuyin
