...
import com.iqianbang.fanpai.adapter.jiaxipiao.JiaXiPiaoFhUseableAdapter;
...
public class FtMinUseablefragment extends BaseFragment {
    ...
    private JiaXiPiaoFhUseableAdapter adapter;
    ...
    protected View initView() {
        ...
        // 5.设置adapter
        adapter=new JiaXiPiaoFhUseableAdapter(mActivity, list);
