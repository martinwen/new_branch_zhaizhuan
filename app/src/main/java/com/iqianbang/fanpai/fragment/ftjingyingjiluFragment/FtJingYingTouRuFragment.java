...
import com.iqianbang.fanpai.adapter.fhinvest.FhTouRuAdapter;
...
public class FtJingYingTouRuFragment extends BaseFragment {
    ...
    private FhTouRuAdapter adapter;
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new FhTouRuAdapter(mActivity, list);
