...
import com.iqianbang.fanpai.adapter.ftinvest.FtAllAdapter;
...
public class FtJingYingAllJiLuFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new FtAllAdapter(mActivity, list);
