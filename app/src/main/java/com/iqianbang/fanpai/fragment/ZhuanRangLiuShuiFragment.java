...
import com.iqianbang.fanpai.adapter.ZhuanRangLiuShuiAdapter;
import com.iqianbang.fanpai.adapter.fwinvest.FwAllAdapter;
...
public class ZhuanRangLiuShuiFragment extends BaseFragment {
    ...
    private ZhuanRangLiuShuiAdapter adapter;
    ...
    protected View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_zaitou, null);
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new ZhuanRangLiuShuiAdapter(mActivity, list);
    ...
    public void setData(String type, String transUuid) {
        this.type = type;
