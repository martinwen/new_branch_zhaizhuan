...
import com.iqianbang.fanpai.adapter.fhinvest.FhShouYiAdapter;
...
public class FtJingYingShouYiFragment extends BaseFragment {
    ...
    private FhShouYiAdapter adapter;
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new FhShouYiAdapter(mActivity, list);
