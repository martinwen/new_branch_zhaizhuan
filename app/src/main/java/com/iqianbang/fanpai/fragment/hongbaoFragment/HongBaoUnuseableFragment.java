package com.iqianbang.fanpai.fragment.hongbaoFragment;
...
import com.iqianbang.fanpai.adapter.hongbao.HongBaoUnuseableAdapter;
...
public class HongBaoUnuseableFragment extends BaseFragment {

	private PullToRefreshListView refreshListView;
	private ListView listView;
	private CustomProgressDialog progressdialog;
	private ArrayList<HongBaoBean> list = new ArrayList<HongBaoBean>();
	private HongBaoUnuseableAdapter adapter;
	...
	protected View initView() {
		...
		// 5.设置adapter
		adapter=new HongBaoUnuseableAdapter(mActivity, list);
