...
import com.iqianbang.fanpai.adapter.yue.ChongZhiAdapter;
...
public class ChongZhiFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        // 5.设置adapter
        adapter = new ChongZhiAdapter(mActivity, list);
