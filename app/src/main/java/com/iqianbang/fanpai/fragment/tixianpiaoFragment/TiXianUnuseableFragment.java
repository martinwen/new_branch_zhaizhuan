...
import com.iqianbang.fanpai.adapter.tixianpiao.TiXianPiaoUnuseableAdapter;
...
public class TiXianUnuseableFragment extends BaseFragment {

	private PullToRefreshListView refreshListView;
	private ListView listView;
	private CustomProgressDialog progressdialog;
	private ArrayList<TiXianBean> list = new ArrayList<TiXianBean>();
	private TiXianPiaoUnuseableAdapter adapter;
	...
	protected View initView() {
		...
		// 5.设置adapter
		adapter=new TiXianPiaoUnuseableAdapter(mActivity, list);
