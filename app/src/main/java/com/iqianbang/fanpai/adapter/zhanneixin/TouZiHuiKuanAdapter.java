...
public class TouZiHuiKuanAdapter extends BaseAdapter {
	...
	public TouZiHuiKuanAdapter(Context context, ArrayList<ZhanNeiXinBean> list) {
		super();
	...
	public TouZiHuiKuanAdapter(Context context) {
		super();
		this.mContext = context;
	}
	...
	public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
		TouZiHuiKuanAdapter.isSelected = isSelected;
	}
