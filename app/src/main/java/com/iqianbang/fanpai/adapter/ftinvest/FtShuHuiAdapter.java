...
public class FtShuHuiAdapter extends BaseAdapter {

	private ArrayList<ShouYiBean> list;
	private Context mContext;

	public FtShuHuiAdapter(Context context, ArrayList<ShouYiBean> list) {
		super();
		this.mContext = context;
		this.list = list;
	}

	public FtShuHuiAdapter(Context context) {
		super();
		this.mContext = context;
	}
