...
public class ZhangHuCaoZuoAdapter extends BaseAdapter {
	...
	public ZhangHuCaoZuoAdapter(Context context, ArrayList<ZhanNeiXinBean> list) {
		super();
	...
	public ZhangHuCaoZuoAdapter(Context context) {
		super();
		this.mContext = context;
	}
	...
	public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
		ZhangHuCaoZuoAdapter.isSelected = isSelected;
	}
