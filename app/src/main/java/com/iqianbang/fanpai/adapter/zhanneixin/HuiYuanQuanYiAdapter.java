...
public class HuiYuanQuanYiAdapter extends BaseAdapter {
	...
	public HuiYuanQuanYiAdapter(Context context, ArrayList<ZhanNeiXinBean> list) {
		super();
	...
	public HuiYuanQuanYiAdapter(Context context) {
		super();
		this.mContext = context;
	}
	...
	public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
		HuiYuanQuanYiAdapter.isSelected = isSelected;
	}
