...
public class FhShuHuiAdapter extends BaseAdapter {

	private ArrayList<ShouYiBean> list;
	private Context mContext;

	public FhShuHuiAdapter(Context context, ArrayList<ShouYiBean> list) {
		super();
		this.mContext = context;
		this.list = list;
	}

	public FhShuHuiAdapter(Context context) {
		super();
		this.mContext = context;
	}
