package com.iqianbang.fanpai.adapter.ftinvest;
...
public class FtAllAdapter extends BaseAdapter {

	private ArrayList<ShouYiBean> list;
	private Context mContext;

	public FtAllAdapter(Context context, ArrayList<ShouYiBean> list) {
		super();
		this.mContext = context;
		this.list = list;
	}

	public FtAllAdapter(Context context) {
		super();
		this.mContext = context;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//201指饭盒，501饭桶
		if ("501".equals(shouYiBean.getTransType())){
		...
		}else if("551".equals(shouYiBean.getTransType())){
			holder.fl_info.setVisibility(View.VISIBLE);
			...
			holder.tv_detail3.setText("元  赎回手续费");
			holder.tv_detail4.setText((MathUtil.subDouble(-shouYiBean.getFee(), 2))+"");
			holder.tv_detail5.setText("元");
		}else {
			//其他类型，金额显示为主颜色
