package com.iqianbang.fanpai.adapter.fwinvest;
...
public class FwAllAdapter extends BaseAdapter {

	private ArrayList<ShouYiBean> list;
	private Context mContext;

	public FwAllAdapter(Context context, ArrayList<ShouYiBean> list) {
		super();
		this.mContext = context;
		this.list = list;
	}

	public FwAllAdapter(Context context) {
		super();
		this.mContext = context;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, R.layout.items_adapter_fwall, null);
		...
		if ("301".equals(shouYiBean.getTransType())){
