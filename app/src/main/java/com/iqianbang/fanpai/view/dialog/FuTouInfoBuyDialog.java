...
public class FuTouInfoBuyDialog extends Dialog implements View.OnClickListener {

	private String maxReturnAmount;
	private String minInvestAmount;
	private String scale;

	public FuTouInfoBuyDialog(Context context) {
		super(context);
	}

	public FuTouInfoBuyDialog(Context context, int theme, String maxReturnAmount, String minInvestAmount, String scale) {
		super(context, theme);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_futouinfobuy);
		initDialog();
	}
	...
	private void initDialog() {
		...
		tv_content_a.setText("回款本金 = 本金*" + scale +"%（复投成功后转入账户余额）");
