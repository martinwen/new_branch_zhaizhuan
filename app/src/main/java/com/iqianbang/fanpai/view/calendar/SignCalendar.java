...
public class SignCalendar extends LinearLayout {
    ...
    private OnClickListener leftArrowClick;
    private OnClickListener rightArrowClick;
     
    
   

	public void setLeftArrowClick(OnClickListener leftArrowClick) {
		this.leftArrowClick = leftArrowClick;
		 leftArrow.setOnClickListener(leftArrowClick);
	}

	public void setRightArrowClick(OnClickListener rightArrowClick) {
...
//        addDivider();
    ...
    private void addDivider() {
        ...
        //修改颜色为全局色
        divider.setBackgroundColor(mContext.getResources().getColor(R.color.global_redcolor));
...
//        }
    ...
    private void setArrowEnable(ImageView arrowImage, Direction direction) {
        if (direction == Direction.LEFT) {
            ...
            Bitmap leftArrowBtp = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sign_arrow_left);
            ...
            arrowImage.setClickable(true);
            Bitmap rightArrowBtp = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sign_arrow_right);
