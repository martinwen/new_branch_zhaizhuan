...
public class FloatDragYxhDuiHuanView {
    ...
    public static ImageView addFloatDragView(Activity context , RelativeLayout mViewContainer,
        ...
        FloatDragYxhDuiHuanView floatDragView = new FloatDragYxhDuiHuanView(context);
    ...
    // 初始化实例
    private FloatDragYxhDuiHuanView(Activity context) {
        setScreenHW(context);
    ...
    private ImageView getFloatDragView(View.OnClickListener clickListener) {
        if (mImageView != null) {
            ...
            mImageView.setImageResource(R.drawable.jiaxipiao_duihuan);
            ...
            public boolean onTouch(final View v, MotionEvent event) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (bottom > mScreenHeight- LockPatternUtil.dip2px(context,100)) {
                            bottom = mScreenHeight- LockPatternUtil.dip2px(context,100);
